...
<section class="width1300">
	...
	<div id="page">
		<ul class="pagination">
			<c:if test="${page.prev}">
				<li>
					<a href='javascript:paging("list?page=${index}&searchStart=${page.criteria.searchStart}&searchEnd=${page.criteria.searchEnd}&state=${page.criteria.state}&meetingRoomId=${page.criteria.meetingRoomId}&searchType=${page.criteria.searchType}&searchContent=${page.criteria.searchContent}")'>&lt;</a>
				</li>
			</c:if>
